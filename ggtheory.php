<?php
  ...
  if (isset($_COOKIE['id']) && isset($_COOKIE['token'])) {
    ...
    if (password_verify($token,$hashedtoken)) {
      header('Location: ggtheoryauth.php');
    }
...
<head>
  ...
  <title>Теория по гидрогеологии</title>
  <meta name="description" content="Описание основных гидрогеологических параметров, актуальных при опытно-фильтрационных работах">
