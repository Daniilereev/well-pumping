<?php
  ...
  if (isset($_COOKIE['id']) && isset($_COOKIE['token'])) {
    ...
    if (password_verify($token,$hashedtoken)) {
      header('Location: ggunitsauth.php');
    }
...
<head>
  ...
  <title>Перевод единиц измерений дебита</title>
  <meta name="description" content="Конвертер дебита скважины и параметров пласта — проводимости, пьезопроводности, коэффициента фильтрации. Метры кубические в сутки перевести в литры в секунду.">
